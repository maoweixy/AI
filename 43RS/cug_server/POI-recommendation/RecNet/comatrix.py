...
def getRatingInformation(ratings):
    ...
    t2=time.time()
    print ("getRatingInformation cost:",t2-t1)
    return rates
...
def createUserRankDic(rates):
    ...
    t2=time.time()
    print ("createUserRankDic cost:",t2-t1)
...
def  creatcomatrix(n,item_to_user,vhash):
    ...
    # print V
    t2=time.time()
    print ("creatcomatrix cost:",t2-t1)
    return V
...
def main() :
    ...
    # test_dic键是userId、值是poiID、POI种类
    # test_item_to_user键poiID
